...
% Suggested figure mapping from the strict pipeline:
% Figure 1: judge figures/layerwise_probe.png + neutral figures/layerwise_probe.png
% Figure 2: judge figures/learning_curve.png + neutral figures/learning_curve.png
% Figure 3: judge figures/nuisance_baselines.png + judge figures/confound_subsets.png
% Figure 4: judge figures/dose_response.png + judge figures/intervention_controls.png
% Figure 5: judge figures/intervention_quality.png
% Figure 6: judge figures/sae_diagnostics.png + judge figures/sae_features.png
%
% IMPORTANT: the current figure_learning_curve implementation labels statement-derived groups
% as "poker hands" in one axis/caption. Change that wording to "statement-derived groups" before
% using the generated figure in the manuscript, because original hand identifiers are not available.
